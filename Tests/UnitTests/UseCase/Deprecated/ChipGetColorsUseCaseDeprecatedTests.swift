//
//  ChipGetColorsUseCaseDeprecatedTests.swift
...
final class ChipGetColorsUseCaseDeprecatedTests: XCTestCase {

    // MARK: - Properties
    private var sut: ChipGetColorsUseCaseDeprecated!
    private var outlinedIntentColorsUseCase: ChipGetIntentColorsUseCaseableDeprecatedGeneratedMock!
    private var tintedIntentColorsUseCase: ChipGetIntentColorsUseCaseableDeprecatedGeneratedMock!
...
// MARK: - Tests
    ...
    func test_outlined_variant_uses_correct_use_case() {
        ...
        let expectedColors = ChipStateColorsDeprecated(
