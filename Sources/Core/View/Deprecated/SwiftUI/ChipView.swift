...
@available(*, deprecated, message: "Use SparkChip instead")
public struct ChipView: View {
    ...
    @ObservedObject private var viewModel: ChipViewModelDeprecated<ChipContent>
    @ScaledMetric private var imageSize = ChipConstants.iconSize
    ...
    internal init(viewModel: ChipViewModelDeprecated<ChipContent>,
                  action: (() -> Void)? = nil) {
