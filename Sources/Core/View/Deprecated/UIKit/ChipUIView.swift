...
@available(*, deprecated, message: "Use SparkUIChip instead")
public final class ChipUIView: UIControl {
    ...
    private let viewModel: ChipViewModelDeprecated<Void>

    private var dashBorder: CAShapeLayer?

    @ScaledUIMetric private var imageSize = ChipConstants.iconSize
    ...
    private func setChipColors(_ chipColors: ChipStateColorsDeprecated) {
